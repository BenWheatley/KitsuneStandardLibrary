...
@synthesize maxSideDelta = _maxSideDelta;
@synthesize pointData = _pointData;
@synthesize maxOctave = _maxOctave;
@synthesize lineThickness = _lineThickness;
@synthesize haloThickness = _haloThickness;
...
-(id) init {
	if ((self=[super init])) {
        ...
        self.color = ccc3(0xFF, 0xFF, 0xFF);
